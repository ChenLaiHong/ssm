...
<%
 ...
 %>
<script src="${APP_PATH}/static/bootstrap-3.3.7-dist/js/jquery-1.11.2.min.js"></script>
<STYLE>
body{
	background: #ebebeb;
...
.u_logo{
	background: url("${APP_PATH}/static/images/username.png") no-repeat;
	padding: 10px 10px;
	position: absolute;
	top: 43px;
	left: 40px;
...
.p_logo{
	background: url("${APP_PATH}/static/images/password.png") no-repeat;
	padding: 10px 10px;
	position: absolute;
	top: 12px;
	left: 40px;
...
<form action="${APP_PATH}/adminLogin.do" method="post" onsubmit="return checkForm()">
